...
class ListaPrincipiantes extends StatefulWidget {
  ListaPrincipiantes();

  @override
  _ListaPrincipiantesState createState() => _ListaPrincipiantesState();
}

class _ListaPrincipiantesState extends State<ListaPrincipiantes> {
  @override
  void initState() {
    super.initState();
  }
...
class VistaEjercicios extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final principiantes = ejercicios
        .where((ejercicio) => ejercicio['nivel'] == 'Principiante')
        .toList();

    return Scaffold(
      body: Center(
        child: ListView.builder(
            itemCount: principiantes.length,
            itemBuilder: (context, posicion) {
              final ejercicio = principiantes[posicion];
              return ListTile(
                onTap: () {
                  Navigator.push(
                    context,
