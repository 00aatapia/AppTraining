...
class ListaAvanzada extends StatefulWidget {
  ListaAvanzada();

  @override
  _ListaAvanzadaState createState() => _ListaAvanzadaState();
}

class _ListaAvanzadaState extends State<ListaAvanzada> {
  @override
  void initState() {
    super.initState();
  }
...
class VistaEjercicios extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final avanzados = ejercicios
        .where((ejercicio) => ejercicio['nivel'] == 'Avanzado')
        .toList();

    return Scaffold(
      body: Center(
        child: ListView.builder(
            itemCount: avanzados.length,
            itemBuilder: (context, posicion) {
              final ejercicio = avanzados[posicion];
              return ListTile(
                onTap: () {
                  Navigator.push(
                    context,
